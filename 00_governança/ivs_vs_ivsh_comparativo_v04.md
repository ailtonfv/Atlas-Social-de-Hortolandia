...
Capital Humano	−0,187 (maior melhoria)	~40–45% ↑	Confirmado: foi a dimensão que mais variou. Isso indica que é onde a política pública teve maior impacto — e onde a vulnerabilidade residual é mais relevante para monitorar.
Renda e Trabalho	−0,139 (segunda maior melhoria)	~35–40% ↑	Confirmado: segunda dimensão mais dinâmica. A tensão entre polo de emprego e vulnerabilidade persistente justifica peso elevado.
...
8	CH_05	% mães chefes de família, sem fund. completo e com filho < 15 anos	CadÚnico ✅	6,25%	~8%	Disponível imediatamente. Alta relevância local — peso elevado no IVS-H.
9	CH_06	Taxa de analfabetismo — população de 15 anos ou mais	CadÚnico ✅ / IBGE Censo 2022	6,25%	~7%	Disponível imediatamente. O Censo 2022 permite validação para população fora do cadastro.
10	CH_07	% crianças em domicílios sem nenhum morador com fund. completo	CadÚnico ✅	6,25%	~8%	Disponível imediatamente. Indicador mais poderoso de reprodução intergeracional da pobreza.
11	CH_08	% jovens de 15 a 24 anos: não estudam, não trabalham e renda ≤ ½ SM	CadÚnico + CAGED	6,25%	~6%	Jovens que não estudam nem trabalham ("geração nem-nem") em situação de vulnerabilidade econômica. Jovens fora do CadÚnico são ponto cego.
---
Dimensão 3 — Renda e Trabalho
5 variáveis | Peso IPEA: 33% | Peso IVS-H (hipótese): ~35–40%
#	Código	Variável	Fonte Municipal	Peso IPEA	Peso IVS-H	Observação
12	RT_01	% pessoas com renda domiciliar per capita ≤ ½ SM	CadÚnico ✅	6,25%	~9%	Disponível imediatamente. Ponto de entrada natural do IVS-H.
...
15	RT_04	% pessoas em domicílios com renda ≤ ½ SM dependentes de idosos	CadÚnico ✅	6,25%	~8%	Disponível imediatamente. Captura fragilidade da renda do idoso como sustentação familiar.
...
v02	2026-03-11	Correção: "3 variáveis" → "5 variáveis" disponíveis no CadÚnico (resumo executivo); padronização de ½ SM; redação CH_08 (geração nem-nem); nota territorial explicitada; nota de limitações do CadÚnico; nota metodológica da dimensão Renda e Trabalho expandida
