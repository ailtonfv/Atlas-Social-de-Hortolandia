[README (3).md](https://github.com/user-attachments/files/27549849/README.3.md)
...
|---|---|---|---|---|
| `01_exploracao_cadunico` | RTB_001 | `01_bruto` | — | Exploração inicial da base |
| `02_tratamento_cadunico` | RTB_002 | `01_bruto` | `02_limpo` | Limpeza e padronização |
| `03_analise_variaveis_cadunico` | RTB_003 | `02_limpo` | `03_curado` | Análise exploratória de variáveis |
| `04_analise_temporal_cadunico` | RTB_004 | `02_limpo` | — | Análise temporal (em desenvolvimento) |
| `05_calculo_ivsh_cadunico` | RTB_005 | `02_limpo` | `03_curado` | Cálculo das variáveis IVS-H |
| `06_perfis_vulnerabilidade` | RTB_006 | `02_limpo` | `outputs/` | Perfis de Vulnerabilidade Severa (PVSE) |
...
Cada edição é classificada em CSVs estruturados com schema versionado, permitindo rastrear ciclos de pressão social ao longo do tempo.
...
- `CH_SAUDE_MENTAL_SITUACAO_RUA_2026` — aberto
