[dim_programa_v05 (1).md](https://github.com/user-attachments/files/26086499/dim_programa_v05.1.md)
# DIM_PROGRAMA — Catálogo de Programas Sociais
**Versão:** v05  
**Data:** "18/03/2026"  
**Responsável:** Ailton Vendramini  
**Repositório:** Atlas-Social-de-Hortolândia / 01_modelagem_conceitual  
**Origem:** Atualizado a partir de `dim_programa_v04.md` — adição de EMPREGA_HORTOLANDIA, FEIRAO_EMPREGO e APP_CURRICULOS ao Grupo 7
...
| v05 | "18/03/2026" | Grupo 7: três novos programas adicionados com base no 1º Fórum de Empregabilidade (17/03/2026) e Tribuna Liberal 18/03/2026 — EMPREGA_HORTOLANDIA (política guarda-chuva, tipo B, ativo), FEIRAO_EMPREGO (evento semestral, tipo A, ativo, 2ª ed. out/2025 com 2.000 atendidos) e APP_CURRICULOS (app banco de currículos, tipo B digital, planejamento, lançamento mai/2026). FATEC: observacoes atualizada com confirmação do Fórum. Total de programas catalogados: 67. |
